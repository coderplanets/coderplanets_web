...
const tmpItems = [
  {
    ...
    title: 'elixir',
    raw: 'elixir',
    logo: 'https://assets.coderplanets.com/icons/pl/elixir.png',
  ...
  },
  {
    ...
    title: 'javascript',
    raw: 'javascript',
    logo: 'https://assets.coderplanets.com/icons/pl/javascript.png',
    desc: 'maybe the most popular UI framework for web, maybe the most popular UI framework for web',
    subscribersCount: 100,
  },
  {
    ...
    title: 'ruby',
    raw: 'ruby',
    logo: 'https://assets.coderplanets.com/icons/pl/ruby.png',
    desc: 'maybe the most popular UI framework for web, maybe the most popular UI framework for web',
    subscribersCount: 100,
  },
  {
    ...
    title: 'clojure',
    raw: 'clojure',
    logo: 'https://assets.coderplanets.com/icons/pl/clojure.png',
    desc: 'maybe the most popular UI framework for web, maybe the most popular UI framework for web',
    subscribersCount: 100,
  },
]
